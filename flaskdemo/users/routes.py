...
from flaskdemo import bcrypt, db
from flaskdemo.models import User, Post
from flaskdemo.users.forms import RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm, ResetPasswordForm
...
def account():
    ...
    return render_template(
        "users/account.html", title="Account", form=form, image_file=image_file
    )
